...
const beskedUrl = 'http://localhost:8080/beskeder/';
const soegbeskedUrl = 'http://localhost:8080/beskeder/';
const rumUrl = 'http://localhost:8080/chatrum/';
...
async function visAlleRum() {
    ...
    for (let r of rum) {
        rumDiv.innerHTML += "<input type=button onclick=\"visBeskederFor('" + 
r.navn + "')\" value=\"" + r.navn + "\"></input>";
    }
}
